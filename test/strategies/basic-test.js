...
const BasicStrategy = require('../../lib/modern-passport-http/strategies/basic');
...
vows.describe('BasicStrategy').addBatch({
  ...
  'strategy handling a request': {
    topic: function() {
      let strategy = new BasicStrategy(function(userid, password, done) {
  ...
  'strategy handling a request that is not verified against specific realm': {
    topic: function() {
      let strategy = new BasicStrategy({ realm: 'Administrators' }, function(userid, password, done) {
        done(null, false);
      });
      return strategy;
    },
  ...
  'strategy with passReqToCallback=true option': {
    topic: function() {
      let strategy = new BasicStrategy({passReqToCallback:true}, function(req, userid, password, done) {
